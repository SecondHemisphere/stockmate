@php
    $cardBase =
        'flex items-center justify-start gap-4 p-3 rounded-xl shadow-md cursor-pointer h-[130px] overflow-hidden transition-all hover:brightness-110';
@endphp
...
<x-layouts.app :title="__('Dashboard')">
    ...
    <div id="criticalStockModal"
        ...
        <div
            class="bg-white p-6 rounded-xl max-w-xl w-full max-h-[85vh] overflow-hidden shadow-2xl border-t-4 border-yellow-500 animate-fade-in">
